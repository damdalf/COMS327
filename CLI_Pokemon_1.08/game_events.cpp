...
{
    // TODO - type to be calculated next assignment.
    // TODO - stab needs to be properly calculated.
    int random;
...
int calculate_damage_pc(int move_idx)
{
    // TODO - type to be calculated next assignment.
    // TODO - stab needs to be properly calculated.
    int random;
    ...
    while (!is_over) {
        ...
        case 49: // 1
            if (string(world.pc.p_list[0].get_move(0)) == "-") pc_dmg = 0;
                ...
                pc_dmg = calculate_damage_pc(pc_move_idx);
            }
            break;
        case 50: // 2
...
// TODO - going to try to write this function without using a user-defined copy constructor. No Pokemon object contains any pointers or objects / structs.
// Deep copies do not need to be made. All information inside of each object are primitives. We're replacing first Pokemon, so that is the Pokemon in which temp 
// should hold.
