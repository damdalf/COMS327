...
string Pokemon ::getIdentifier() const { return identifier; }
int Pokemon ::getSpeciesID() const { return species_id; }
int Pokemon ::getHeight() const { return height; }
int Pokemon ::getWeight() const { return weight; }
int Pokemon ::getBaseExperience() const { return base_experience; }
int Pokemon ::getOrder() const { return order; }
int Pokemon ::getIsDefault() const { return is_default; }
void Pokemon ::print()
{
...
string Move ::getIdentifier() const { return identifier; }
int Move ::getGenerationID() const { return generation_id; }
int Move ::getTypeID() const { return type_id; }
...
int Move ::getTargetID() const { return target_id; }
int Move ::getDamageClassID() const { return damage_class_id; }
int Move ::getEffectID() const { return effect_id; }
int Move ::getEffectChance() const { return effect_chance; }
int Move ::getContestTypeID() const { return contest_type_id; }
int Move ::getContestEffectID() const { return contest_effect_id; }
int Move ::getSuperContestEffectID() const { return super_contest_effect_id; }
void Move ::print()
{
    (id != -1) ? cout << "ID: " << id << endl : cout << "ID: " << endl;
    (identifier != "-1") ? cout << "IDENTIFIER: " << identifier << endl : cout << "IDENTIFIER: " << endl;
...
int Pokemon_Move ::getPokemonID() const { return pokemon_id; }
int Pokemon_Move ::getVersionGroupID() const { return version_group_id; }
int Pokemon_Move ::getMoveID() const { return move_id; }
int Pokemon_Move ::getPokemonMoveMethodID() const { return pokemon_move_method_id; }
int Pokemon_Move ::getLevel() const { return level; }
int Pokemon_Move ::getOrder() const { return order; }
...
int Pokemon_Species ::getID() const { return id; }
string Pokemon_Species ::getIdentifier() const { return identifier; }
int Pokemon_Species ::getGenerationID() const { return generation_id; }
int Pokemon_Species ::getEvolvesFromSpeciesID() const { return evolves_from_species_id; }
int Pokemon_Species ::getEvolutionCHainID() const { return evolution_chain_id; }
int Pokemon_Species ::colorID() const { return color_id; }
int Pokemon_Species ::getShapeID() const { return shape_id; }
int Pokemon_Species ::getHabitatID() const { return habitat_id; }
int Pokemon_Species ::getGenderRate() const { return gender_rate; }
int Pokemon_Species ::getCaptureRate() const { return capture_rate; }
int Pokemon_Species ::getBaseHappiness() const { return base_happiness; }
int Pokemon_Species ::getIsBaby() const { return is_baby; }
int Pokemon_Species ::getHatchCounter() const { return hatch_counter; }
int Pokemon_Species ::getHasGenderDifferences() const { return has_gender_differences; }
int Pokemon_Species ::getGrowthRateID() const { return growth_rate_id; }
int Pokemon_Species ::getFormsSwitchable() const { return forms_switchable; }
int Pokemon_Species ::getIsLegendary() const { return is_legendary; }
int Pokemon_Species ::getIsMythical() const { return is_mythical; }
int Pokemon_Species ::getOrder() const { return order; }
int Pokemon_Species ::getConquestOrder() const { return conquest_order; }
...
int Experience ::getGrowthRateID() const { return growth_rate_id; }
int Experience ::getLevel() const { return level; }
int Experience ::getExperience() const { return experience; }
...
int Type_Name ::getTypeID() const { return type_id; }
int Type_Name ::getLocalLanguageID() const { return local_language_id; }
string Type_Name ::getName() const { return name; }
