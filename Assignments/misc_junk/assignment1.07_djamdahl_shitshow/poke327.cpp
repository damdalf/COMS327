...
void init_world()
{
  ...
  parseAll(&world.pokemonList, &world.movesList, &world.pokemonMovesList, &world.pokemonSpeciesList, &world.experienceList, &world.typeNamesList, &world.pokemonStatsList);
}
